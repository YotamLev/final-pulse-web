...
export const DISCIPLINES: Record<string, Discipline> = {
  ...
  Dominate: {
    ...
    powers: [
      ...
      { name: "Mesmerize", level: 2, description: "Pay 1 Blood, target a mortal (roll Dominate if they resist), cause a simple task for about a scene. Task can't be suicidal. Mortals remember the task but not why.", requires: null },
  ...
  Fortitude: {
    ...
    powers: [
      ...
      { name: "Flesh of Marble", level: 3, description: "Pay 2 Blood, take no damage for 1 turn.", requires: null },
  ...
  Nightmare: {
    ...
    powers: [
      { name: "Haunt Dream", level: 1, description: "Appear in a mortal's dreams, give them messages. Can be activated during day and from torpor.", requires: null },
      { name: "Lullaby", level: 1, description: "Put an unsuspecting mortal to sleep, or a group of mortals by paying 1 Blood. Suspecting mortals or stressful environments may require a Nightmare roll.", requires: null },
      { name: "It Was All a Bad Dream", level: 1, description: "Cause all mortals in a scene to believe whatever scary thing they just saw was a dream or has a mundane explanation.", requires: null },
      { name: "Melpominee", level: 1, description: "Cast your voice to sound as if coming from a point you can see.", requires: null },
      { name: "Dread Gaze", level: 2, description: "Add Nightmare to Intimidation rolls, create scary illusions of your appearance. A +3 margin can paralyze a target for a turn.", requires: null },
      { name: "Haunting Ground", level: 2, description: "Activate to cause mortals to subconsciously avoid an area when you are there.", requires: null },
      ...
      { name: "Illusion", level: 3, description: "Pay 1 Blood, create a small motionless illusion affecting one sense. Each additional sense, motion, or size increase costs 1 more Blood.", requires: null },
      { name: "Summon Nightmare", level: 4, description: "Pay 1 Blood, attack a target with its worst fear, rolling Nightmare, inflicting Willpower damage.", requires: "Paranoia" },
    ],
  },
  Obfuscate: {
  ...
  Presence: {
    ...
    powers: [
      ...
      { name: "Susceptible", level: 5, description: "Mortals exposed to your Presence powers act as loyal as Ghouls, for a night.", requires: null },
    ],
  },
  Protean: {
